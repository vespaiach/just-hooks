...
function useLocalStorage(keyOrFn, initialValue, options) {
  var _ref = options || {},
      ...
      parse = _ref$parse === void 0 ? JSON.parse : _ref$parse,
      _ref$stringify = _ref.stringify,
      stringify = _ref$stringify === void 0 ? JSON.stringify : _ref$stringify;

  var storageKey = typeof keyOrFn === 'function' ? keyOrFn() : keyOrFn;
  ...
  var saveVal = react.useCallback(function (val) {
    try {
      setVal(val);
