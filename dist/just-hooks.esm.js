...
var getResponseType = function getResponseType(contentType) {
...
function safeFetch(_x, _x2) {
  return _safeFetch.apply(this, arguments);
}

function _safeFetch() {
  _safeFetch = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(input, init) {
    var response, contenttype, responseType, data, ok;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            responseType = contenttype ? getResponseType(contenttype.toLocaleLowerCase()) : null;
            ok = response.ok;
          ...
          case 15:
            ...
            ok = false;
            data = new APIError(_context.t0.toString());
    ...
    }, _callee, null, [[0, 30], [8, 15]]);
  }));
  return _safeFetch.apply(this, arguments);
}

var toQueryString = function toQueryString(params) {
  return Object.entries(params).reduce(function (acc, p) {
    return "" + acc + (acc === '' ? '' : '&') + p;
  }, '');
};

function useAPIFetch(commonOptions) {
  var request = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(url, method, params, headers) {
      var endpoint, body;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (params) {
                if (method === 'GET' || method === 'HEAD') {
                  endpoint = url.indexOf('?') > -1 ? url + "&" + toQueryString(params) : url + "?" + toQueryString(params);
                } else {
                  body = JSON.stringify(params);
                }
              }

              return _context.abrupt("return", safeFetch(endpoint, _extends({}, commonOptions, {
                headers: Object.assign({}, commonOptions == null ? void 0 : commonOptions.headers, headers, {
  ...
  var get = function get(url, params, headers) {
  ...
  var del = function del(url, params, headers) {
    return request(url, 'DELETE', params, headers);
  };

  var head = function head(url, params, headers) {
    return request(url, 'HEAD', params, headers);
  };

  var patch = function patch(url, params, headers) {
    return request(url, 'PATCH', params, headers);
  };

  var put = function put(url, params, headers) {
    return request(url, 'PUT', params, headers);
  };
...
export { APIError, safeFetch, useAPIFetch, useTransferList };
